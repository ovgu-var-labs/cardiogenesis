...
/// Also handles rotation of mudrenderer
/// </summary>
public class StageManager : MonoBehaviour
{
    ...
    public void LoadNextStage()
    {
        ...
        // Old
        /*
        stages[(currentStage + 1) % stages.Length].SetActive(true);
    ...
    {
        int stageToLoadID = (currentStage - 1) % stages.Length;
        Debug.Log("Stage to load " + stageToLoadID);
        SetLoadStage(stageToLoadID);
    ...
    {
        stages[currentStage].GetComponent<GlobalAnimationManager>().UpdateAnimationTo(animationProgress, false);
    }
