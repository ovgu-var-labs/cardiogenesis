...
public class PukNotationScript : MonoBehaviour
{
    ...
    private Vector3 CreateVectorCameraObject()
    {
        ...
        Vector3 vectorCameraObject_ = pose.position - gameObject.transform.position;
        return vectorCameraObject_;
    }

    private void RotateTowardPlayer()
    {
        backPlate.transform.forward = Vector3.RotateTowards(backPlate.transform.forward, vectorCameraObject, 360f, 0f);
    }
