...
public class MeshVisualizer : MonoBehaviour
{
    ...
    private float progress;                                 // How far the animation has progressed
    ...
    void Start()
    {
        ...
        {
            globalAnimation = gameObject.GetComponentInParent<GlobalAnimationManager>();
            if (globalAnimation == null)
    ...
    private float GetProgressFromAnimationManager(GlobalAnimationManager globalAnimationManager)
    {
        return globalAnimationManager.GetAnimationProgress();
    }

    private void UpdateProgress()
    {
        progress = GetProgressFromAnimationManager(globalAnimation);
    }
