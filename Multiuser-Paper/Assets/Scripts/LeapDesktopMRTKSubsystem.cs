...
namespace Leap.Unity.MRTK
{
    ...
    [MRTKSubsystem(
        ...
        DisplayName = "Subsystem for Ultraleap Hands API (Desktop, Non-OpenXR)",
        Author = "Ultraleap",
        ProviderType = typeof(LeapDesktopMRTKProvider),
        SubsystemTypeOverride = typeof(LeapDesktopMRTKSubsystem),
        ConfigType = typeof(BaseSubsystemConfig))]
    public class LeapDesktopMRTKSubsystem : HandsSubsystem
    {
        [RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.SubsystemRegistration)]
        private static void Register()
        {
            bool subsystemEnabled = MRTKProfile.Instance.LoadedSubsystems.Contains(typeof(LeapDesktopMRTKSubsystem));
            ...
            var cinfo = XRSubsystemHelpers.ConstructCinfo<LeapDesktopMRTKSubsystem, HandsSubsystemCinfo>();
        ...
        /// </summary>
        [Preserve]
        private class LeapDesktopMRTKProvider : Provider, IHandsSubsystem
        {
            ...
            {
                LeapDesktopMRTKSubsystem LeapDesktopMRTKSubsystem = XRSubsystemHelpers.GetFirstRunningSubsystem<LeapDesktopMRTKSubsystem>();

                if (LeapDesktopMRTKSubsystem == null)
                {
                    return;
                }
                ...
                {
                    Debug.Log("There are no LeapProviders in the scene, automatically assigning a LeapServiceProvider for use with Ultraleap Subsystem for MRTK");


                    GameObject leapProviderGO = new GameObject("LeapServiceProvider");
                    LeapServiceProvider leapServiceProvider = leapProviderGO.AddComponent<LeapServiceProvider>();
